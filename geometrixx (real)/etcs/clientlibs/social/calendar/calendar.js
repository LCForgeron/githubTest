...
(function(CQ, $CQ) {
	...
	CQ.soco.calendar.utils.invokeFullCalendar = function(divTarget, url) {
		var _cal = $CQ(divTarget).fullCalendar({
			...
			buttonText: {
				prev: '<img src="/geometrixx/etcs/designs/geometrixx-outdoors/images/soco/mini-calendar-nav-left.png">',
				next: '<img src="/geometrixx/etcs/designs/geometrixx-outdoors/images/soco/mini-calendar-nav-right.png">'
			},
